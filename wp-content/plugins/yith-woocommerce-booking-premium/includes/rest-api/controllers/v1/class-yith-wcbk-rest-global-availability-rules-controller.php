...
class YITH_WCBK_REST_Global_Availability_Rules_Controller extends WP_REST_Controller {
	...
	public function create_item_permissions_check( $request ) {
		if ( ! yith_wcbk_rest_check_manager_permissions( 'global_availability_rules', 'create', $request ) ) {
	...
	public function get_items_permissions_check( $request ) {
		if ( ! yith_wcbk_rest_check_manager_permissions( 'global_availability_rules', 'read', $request ) ) {
	...
	public function update_item_permissions_check( $request ) {
		if ( ! yith_wcbk_rest_check_manager_permissions( 'global_availability_rules', 'update', $request ) ) {
	...
	public function delete_item_permissions_check( $request ) {
		if ( ! yith_wcbk_rest_check_manager_permissions( 'global_availability_rules', 'delete', $request ) ) {

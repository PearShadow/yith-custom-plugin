...
if ( ! class_exists( 'YITH_WCBK_Assets' ) ) {
	...
	class YITH_WCBK_Assets {
		...
		public function get_scripts( string $context ): array {
			...
			$common_scripts = array(
				...
				'yith-wcbk-people-selector' => array(
					...
					'localize'         => array(
						/**
						 * APPLY_FILTERS: yith_wcbk_js_people_selector_params
						 *
				...
				'yith-wcbk-datepicker'      => array(
					...
					'localize'         => array(
						'yith_wcbk_datepicker_params' => array(
							/**
							 * APPLY_FILTERS: yith_wcbk_i18n_clear
							 *
			...
			/**
			 * APPLY_FILTERS: yith_wcbk_scripts
			 *
		...
		public function get_styles( string $context ): array {
			...
			/**
			 * APPLY_FILTERS: yith_wcbk_styles
			 *
		...
		protected function get_globals( string $context ): array {
			...
			if ( 'admin' === $context ) {
				$globals['wcbk_admin'] = array(
					...
					/**
					 * APPLY_FILTERS: yith_wcbk_admin_js_disable_wc_check_for_changes
					 *
					 * Filters if disabling the WooCommerce check for changes in settings panels.
					 *
					 * @param bool $disable True to disable the check; false otherwise.
					 *
					 * @return bool
					 */
		...
		public static function get_bk_global_params( string $context = 'common' ): array {
			...
			/**
			 * APPLY_FILTERS: yith_wcbk_assets_bk_global_params
			 *
			 * Filters params of the global 'bk' JS variable.
			 *
			 * @param array  $bk      The params.
			 * @param string $context The context.
			 *
			 * @return array
			 */
